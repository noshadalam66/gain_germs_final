...
//
// class UpdateEmailQIBDialog extends StatelessWidget {
//   final String? title;
...
//         this.titleWidget,
//         this.type,
//         this.children, this.contentList});
//
//   @override
...
//                                 description!,
//                                 textAlign: TextAlign.center,
//                                 style: GainGermsText(typo: Typo.H5).style(),
//                               ),
//                               SizedBox(
...
//                                         ),
//                                         Icon(Icons.check,color: GainGermsTheme().getTheme().blue,size: 12,),
//                                         SizedBox(
//                                           width: responsiveWidth(17),
//                                         ),
//                                         Text('${contentList![index]}',
//                                           style: GainGermsText(
//                                               typo: Typo.H5,  color: GainGermsTheme().isDarkMode()?GainGermsTheme().getTheme().all_segments_white:GainGermsTheme().getTheme().headerColor)
//                                               .style(),
//                                         ),                                              ],
//                                     ),)),
//                               SizedBox(
