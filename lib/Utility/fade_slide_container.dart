...
class FadeSlideContainer extends StatefulWidget {
  ...
  /// Curve of the sliding animations
  ...
  const FadeSlideContainer({
    required this.child,
    this.delay = Duration.zero,
    this.fadingDuration = const Duration(milliseconds: 1200),
  ...
  @override
  _FadeSlideContainerState createState() => _FadeSlideContainerState();
}

class _FadeSlideContainerState extends State<FadeSlideContainer>
  ...
  /// or out animation.
  @override
  void didUpdateWidget(FadeSlideContainer oldWidget) {
